...
checkpoint_cb = ModelCheckpoint(path + '200w_model_v5.h5', save_best_only=True)
...
if not os.path.isdir(r'E:\slproject\plots'):
    os.mkdir(r'E:\slproject\plots')

print('\nSaving learning curves graph . . .')
pd.DataFrame(history.history).plot(figsize=(9, 6))
plt.grid(True)
plt.gca().set_ylim(0, 4)
plt.savefig(r'E:\slproject\plots\learning_curves.png')
